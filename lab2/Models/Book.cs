...
namespace lab2.Models
{
    ...
    public class BookManager
    {
        public static List<Book> GetBooks()
        {
            ...
            books.Add(new Book { BookId = 5, Title = "Feugait Eros Libex", Author = "Futurum", CoverImage = "Assets/5.png" });
            books.Add(new Book { BookId = 6, Title = "Nonummy Erat", Author = "Futurum", CoverImage = "Assets/6.png" });
            ...
            books.Add(new Book { BookId = 9, Title = "Suscipit Ad", Author = "Futurum", CoverImage = "Assets/9.png" });
            ...
            books.Add(new Book { BookId = 13, Title = "Aliquip", Author = "Futurum", CoverImage = "Assets/13.png" });
